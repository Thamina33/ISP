...
public class nottiFicationPage extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<model , viewholderForNottification> firebaseRecyclerAdapter ;
    ...
    private  void loadData(){
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<model, viewholderForNottification>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final   viewholderForNottification holder, final int position, @NonNull model model) {
